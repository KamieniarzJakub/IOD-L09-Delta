...
class ConditionalStepCounterTest {
    ConditionalStepCounter conditionalStepCounter;

    @BeforeEach
    void setUp(){
        conditionalStepCounter = new ConditionalStepCounter();
    }

    // mock
    @Test
    void testCountConditionalStepsEmpty() {
        Scenario mockScenario = mock(Scenario.class);
        when(mockScenario.getSteps()).thenReturn(List.of());
        assertEquals(0,conditionalStepCounter.countConditionalSteps(mockScenario));
    }

    // mock
    @Test
    void testCountConditionalStepsNull() {
        Scenario mockScenario = mock(Scenario.class);
    ...
    @Test
    void testCountConditionalSteps() {
      ...
      assertEquals(2,conditionalStepCounter.countConditionalSteps(scenario));
    }
}