...
public class TextConstants {
    static final String keywordPhrase = "Ilość kroków rozpoczynających się od słowa kluczowego: ";
    static final String conditionalPhrase = "Ilość decyzji warunkowych: ";
