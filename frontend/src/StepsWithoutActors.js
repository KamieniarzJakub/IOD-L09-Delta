...
function StepsWithoutActors() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const res = await fetch('/steps-without-actors', {
        method: 'POST',
        headers: {
  ...
  return (
    ...
    >
      ...
      <h1 style={{ color: isDarkMode ? '#61dafb' : '#4a90e2' }}>Kroki Bez Aktora</h1>
      <form
...
export default StepsWithoutActors;
